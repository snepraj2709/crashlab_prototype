export const aboutContent = {
  ...
  pillars: [
    {
      label: "Data",
      description: "India-specific clinical datasets that reflect real hospital diversity, not curated edge cases."
    },
    {
      label: "Benchmarks",
      description: "Evaluation frameworks built with radiologists and clinicians, stress-tested against deployment reality."
    },
    {
      label: "Design",
      description: "Human-centred AI systems that fit clinical workflows rather than disrupting them."
    },
    {
      label: "Models",
