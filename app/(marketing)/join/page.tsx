  ...
  return (
    <section className="pt-32 pb-24 lg:pb-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16">
          <h2 className="font-display text-4xl text-white">What we&apos;re working on</h2>
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-2">
          <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-8">
            <h2 className="font-display text-4xl text-white">Who thrives here</h2>
          ...
          <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-8">
            <h2 className="font-display text-4xl text-white">What you&apos;ll get</h2>
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              {benefits.map((benefit) => (
                <div className="rounded-[24px] border border-white/10 bg-bg-surface p-5" key={benefit}>
        ...
        <div className="mt-16 rounded-[28px] border border-white/10 bg-white/[0.03] p-8">
          <h2 className="font-display text-4xl text-white">Open roles</h2>
          <div className="mt-8 flex flex-wrap gap-4">
            {roles.map((role) => (
              <div className="rounded-full border border-white/10 px-5 py-3 text-white" key={role}>
                {role}
              </div>
            ))}
          </div>
